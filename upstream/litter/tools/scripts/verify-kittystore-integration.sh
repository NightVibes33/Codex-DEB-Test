...
require_grep "emexDE LiveProcess extension bundle id is DarkSword-prefixed" "PRODUCT_BUNDLE_IDENTIFIER: com.nightvibes.darkswordai.39A8Q3T3TR.liveprocess" "apps/ios/project.yml"
...
require_grep "emexDE private LiveProcess workflow bundle id is DarkSword-prefixed" 'PRODUCT_BUNDLE_IDENTIFIER="com.nightvibes.darkswordai.39A8Q3T3TR.liveprocess"' ".github/workflows/ios-unsigned-ipa.yml"
