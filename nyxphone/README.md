...
NyxPhone is an iPhone/iPad-only virtual-phone experiment. The native VibeContainers host links a purpose-built NyxRuntime interpreter and integrates the pinned Nyxian userspace-kernel surface. It does not use QEMU, Virtualization.framework, or a companion computer.

Current milestone: M0 source integration and physical-device unsigned IPA packaging.
