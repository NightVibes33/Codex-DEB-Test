...
## Overlay log tail
```text
patching file 'shared/rust-bridge/codex-mobile-client/src/lib.rs'
patching file 'shared/rust-bridge/codex-mobile-client/src/ish_runtime.rs'
1 out of 1 hunks failed--saving rejects to 'shared/rust-bridge/codex-mobile-client/src/ish_runtime.rs.rej'
patching file 'shared/rust-bridge/codex-mobile-client/src/local_runtime_instructions.rs'
1 out of 1 hunks failed--saving rejects to 'shared/rust-bridge/codex-mobile-client/src/local_runtime_instructions.rs.rej'
```
